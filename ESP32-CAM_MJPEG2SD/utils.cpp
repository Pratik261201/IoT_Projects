...
/** Use the web interface to configure wifi setting

 
/** Do not hard code anything below here unless yos **/
#include <esp_task_wdt.h>
char hostName[MAX_HOST_LEN] = ""; // Default Host name
char ST_SSID[MAX_HOST_LEN]  = "Divyansh"; //Default router ssid
char ST_Pass[MAX_PWD_LEN] = "honeybhai"; //Default router passd
